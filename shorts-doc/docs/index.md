...
Спасибо, что пользуетесь **Shorts Generator**!

Если у вас возникли вопросы, предложения по улучшению программы или вы обнаружили ошибку — свяжитесь со мной любым удобным способом.

---

### 📺 YouTube

На канале публикуются обзоры новых версий программы, инструкции и примеры созданных Shorts.

**https://www.youtube.com/@Smart_AutoClickers**

---

### 💬 Telegram-канал

Новости проекта, анонсы обновлений и полезные материалы.

**https://t.me/smart_autoclickers**

---

### 📥 Скачать последнюю версию

Всегда актуальная версия программы доступна на GitHub.

**https://github.com/Radomur/shorts_generator/releases/latest**

---

### 📩 Техническая поддержка

Если возникла проблема с работой программы или лицензией, напишите в Telegram.

**https://t.me/vlad_qa_auto**



Перед обращением в поддержку, чтобы быстрее разобраться в проблеме, пожалуйста:
...
4. По возможности приложите скриншот ошибки.
