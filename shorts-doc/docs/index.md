...
Если у вас возникли вопросы по работе программы, предложения по улучшению или вы обнаружили ошибку, воспользуйтесь следующими контактами:
...
- 🌐 **Скачать последнюю версию программы:** <https://github.com/Radomur/shorts_generator/releases/download/v1.0.0/install_shorts_generator.zip>
- 📧 **Техническая поддержка:** <https://t.me/vlad_qa_auto>

### Перед обращением в поддержку

Чтобы мы смогли быстрее разобраться в проблеме, рекомендуется:

1. Проверить раздел **10. Решение распространённых проблем**.
2. Сохранить текст последних логов генерации (кнопкой **«💾 Сохранить TXT»** в окне логов или скопировать их вручную).
3. Указать версию программы (отображается в разделе **«О программе»**, текущая версия — **1.0.0**).
4. По возможности приложить скриншот сообщения об ошибке.

---

© 2026 **Smart AutoClickers**

Разработка программного обеспечения для автоматизации создания контента.
