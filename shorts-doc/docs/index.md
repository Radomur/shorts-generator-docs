...
В разделе **«О программе»** (левое меню) доступны:

- **YouTube-канал** разработчика — обучающие материалы и новости;
- **Telegram** — бот/канал, связанный с программой;
- **Поддержка** — прямая связь с разработчиком по возникшим вопросам.

Перед обращением в поддержку рекомендуется:

1. Проверить раздел 10 этого руководства.
2. Сохранить (кнопкой «💾 Сохранить TXT» в окне ревью или скопировав вручную) текст последних логов генерации.
3. Указать версию программы (отображается в разделе «О программе», текущая — 1.0.0).

---

*© 2026. Данное руководство описывает интерфейс и функциональность программы Shorts Generator версии 1.0.0. Внешний вид отдельных элементов может отличаться в новых версиях программы.*
